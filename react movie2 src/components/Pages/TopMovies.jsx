...
export default function TopMovies() {
  ...
  function Changepagination(page) {
    setLoading(true);
    fetch(
      `https://api.themoviedb.org/3/movie/top_rated?api_key=26b842803ccbaba051d1fd7169b8d506&language=en-US&page=${page}`
    )
  ...
  useEffect(() => {
    setLoading(true);
    fetch(
      "https://api.themoviedb.org/3/movie/top_rated?api_key=26b842803ccbaba051d1fd7169b8d506&language=en-US&page=1"
    )
      .then((response) => response.json())
      .then((data) => setPost(data))
      .finally(() => setLoading(false));
